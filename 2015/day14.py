...
class Reindeer:
    ...
    def all_from_description(cls, description: str) -> 'Sequence[Reindeer]':
        ...
        """
        return tuple(cls.from_description_line(line) for line in description.split('\n'))
...
class ReindeerStatus:
    ...
    def progress(self):
        ...
        if self.time_left == 0:
            ...
            self.time_left = self.reindeer.flytime if self.flying else self.reindeer.rest_needed
