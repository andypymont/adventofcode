...
def find_opcodes(operations: Dict[str, Operation], samples: List[Sample]) -> Dict[int, Operation]:
...
def main() -> None:
    ...
    print(f'Part 1: {sum(1 for sample in samples if sample.possible_operations(OPERATIONS) >= 3)}')
