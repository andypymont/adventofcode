...
class Point:
    ...
    def angle(self) -> int:
        return int(
            np.arctan2(-self.x, self.y) / (np.pi*2) * 36_000
        ) % 360_000
...
def best_station_visibility(asteroids: Iterable[Point]) -> Tuple[Point, int]:
    visibility = {
        asteroid: asteroid.visible_points(asteroids)
...
def test_part2() -> None:
    ...
    """
    asteroids = {
        Point(0, 1), Point(0, 6), Point(0, 7), Point(0, 8), Point(0, 9), Point(0, 10),
        Point(0, 14), Point(1, 0), Point(1, 1), Point(1, 5), Point(1, 6), Point(1, 8),
        Point(1, 9), Point(1, 10), Point(1, 11), Point(1, 12), Point(1, 15), Point(1, 16),
        Point(2, 0), Point(2, 1), Point(2, 5), Point(2, 9), Point(2, 11), Point(2, 12),
        Point(2, 13), Point(2, 14), Point(2, 15), Point(3, 2), Point(3, 8), Point(3, 12),
        Point(3, 13), Point(3, 14), Point(4, 2), Point(4, 4), Point(4, 10), Point(4, 15),
        Point(4, 16),
    }
