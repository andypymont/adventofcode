...
def basin_size(heightmap: Dict[complex, int], lowpoint: complex) -> int:
    ...
    while explore:
        ...
        explore.extend(
            neighbour
            for neighbour in [location + direction for direction in (0-1j, 1+0j, 0+1j, -1+0j)]
...
def test_part1() -> None:
    ...
    heightmap = {
        0+0j: 2, 1+0j: 1, 2+0j: 9, 3+0j: 9, 4+0j: 9, 5+0j: 4, 6+0j: 3, 7+0j: 2, 8+0j: 1, 9+0j: 0,
        0+1j: 3, 1+1j: 9, 2+1j: 8, 3+1j: 7, 4+1j: 8, 5+1j: 9, 6+1j: 4, 7+1j: 9, 8+1j: 2, 9+1j: 1,
        0+2j: 9, 1+2j: 8, 2+2j: 5, 3+2j: 6, 4+2j: 7, 5+2j: 8, 6+2j: 9, 7+2j: 8, 8+2j: 9, 9+2j: 2,
        0+3j: 8, 1+3j: 7, 2+3j: 6, 3+3j: 7, 4+3j: 8, 5+3j: 9, 6+3j: 6, 7+3j: 7, 8+3j: 8, 9+3j: 9,
        0+4j: 9, 1+4j: 8, 2+4j: 9, 3+4j: 9, 4+4j: 9, 5+4j: 6, 6+4j: 5, 7+4j: 6, 8+4j: 7, 9+4j: 8
    }
